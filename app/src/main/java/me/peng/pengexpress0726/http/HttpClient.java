...
import me.peng.pengexpress0726.application.ExpressApplication;
...
public class HttpClient {
    ...
    public static void getSuggestion(final String postId, final HttpCallback<SuggestionResult> callback){
        ...
        GsonRequest<SuggestionResult> request = new GsonRequest<SuggestionResult>(Request.Method.POST, url,
