package me.peng.pengexpress0726.utils.permission;
...
public class PermissionReq {
    ...
    public PermissionReq result(@NonNull PermissionResult result){
        mResult = result;
        return this;
    }
    ...
    public void request(){
        ...
        if (activity == null){
            throw new IllegalArgumentException(mObject.getClass().getName()
                    + " is not supported");
        }
